...
INSERT INTO packages(name, new_refi, float_fixed, hdb_pvt, buc_completed, lock_in, min_loan, rate_1, operator_1, spread_1, rate2, operator_2, spread_2, rate_3, operator_3, spread_3, remarks, bank_id) VALUES('CITI 1M Sibor, 2Yrs lock-in (Min loan $500k)', 'both', 'float', 'private', 'completed', true, 500000, 1, +, 0.3, 1, +, 0.3, 1, +, 0.4, 'legal subsidy for refi is 0.2% of loan amount capped at $2,500. Comes with 50% interest offset. Waiver of prepayment fee due to sale of property.', 3);
INSERT INTO packages(name, new_refi, float_fixed, hdb_pvt, buc_completed, lock_in, min_loan, rate_1, operator_1, spread_1, rate2, operator_2, spread_2, rate_3, operator_3, spread_3, remarks, bank_id) VALUES('CITI 2Yrs Fixed, 2Yrs lock-in (Min loan $500k)', 'both', 'fixed', 'private', 'completed', true, 500000, 5, +, 0, 5, +, 0, 1, +, 0.9, 'legal subsidy for refi is 0.2% of loan amount capped at $2,500', 3);
INSERT INTO packages(name, new_refi, float_fixed, hdb_pvt, buc_completed, lock_in, min_loan, rate_1, operator_1, spread_1, rate2, operator_2, spread_2, rate_3, operator_3, spread_3, remarks, bank_id) VALUES('CITI 1M Sibor, 2Yrs lock-in (Min loan $500k)', 'new', 'float', 'private', 'buc', false, 500000, 1, +, 0.25, 1, +, 0.25, 1, +, 0.45, 'Min loan $500K. Comes with 50% interest offset.', 3);
INSERT INTO packages(name, new_refi, float_fixed, hdb_pvt, buc_completed, lock_in, min_loan, rate_1, operator_1, spread_1, rate2, operator_2, spread_2, rate_3, operator_3, spread_3, remarks, bank_id) VALUES('CITI 3Yrs Fixed, 2Yrs lock-in (Min loan $500k)', 'both', 'fixed', 'private', 'completed', true, 500000, 6, +, 0, 6, +, 0, 6, +, 0, 'legal subsidy for refi is 0.2% of loan amount capped at $2,500', 3);